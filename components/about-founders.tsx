      ...
      <div className="relative mx-auto max-w-6xl px-4 md:px-6">
        ...
        <div className="mt-16 grid gap-12 md:mt-20 md:grid-cols-2 md:gap-10 lg:gap-16">
          {founders.map((founder, index) => (
            ...
            >
              <div className="relative aspect-[3/4] overflow-hidden rounded-[28px] border border-border bg-card">
                <img
              ...
              <p className="mt-6 font-mono text-xs tracking-[0.25em] text-primary uppercase">
                {founder.role}
              </p>
