...
export function WorldMap({
  ...
  // Site is always dark — skip next-themes
  ...
  return (
    <div className="relative aspect-[2/1] w-full overflow-hidden rounded-xl bg-transparent font-sans md:aspect-[2.5/1] lg:aspect-[2/1]">
      <Image
                  ...
                  >
                    ...
                    >
                      <div className="flex h-full items-center justify-center">
                        <span className="rounded-md border border-border bg-card/95 px-2 py-0.5 text-sm font-medium text-foreground shadow-sm">
                          {dot.start.label}
                        </span>
                      </div>
                    </foreignObject>
      ...
      <AnimatePresence>
        {hoveredLocation && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 10 }}
            className="absolute bottom-4 left-4 rounded-lg border border-border bg-card/90 px-3 py-2 text-sm font-medium text-foreground backdrop-blur-sm sm:hidden"
          >
            {hoveredLocation}
          </motion.div>
        )}
